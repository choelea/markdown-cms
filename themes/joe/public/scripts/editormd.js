...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        save : function() {
            ...
            var stripMetaContent = editormd.stripMeta(cmValue)
            var newMarkdownDoc = editormd.$marked(stripMetaContent, markedOptions);
     ...
     */
    editormd.stripMeta = function(markdownContent){
